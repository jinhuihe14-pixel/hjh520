...
import { Sun, Moon, Download, Save, Trash2, Plus, FileText } from 'lucide-react';
    ...
    <div className="h-16 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border-t border-slate-700/50 flex items-center px-4 gap-4">
      ...
      {currentProject && (
        <div className="flex items-center gap-2">
          ...
          >
            <span>💰</span>
            <span>{formatPrice(quote.totalCost)}</span>
          </button>

          {showQuote && (
            <div className="absolute bottom-16 right-40 w-72 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-50 overflow-hidden">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="border-t border-slate-700 pt-3 flex justify-between">
                  ...
                  <span className="text-amber-400 font-bold text-lg">{formatPrice(quote.totalCost)}</span>
                </div>
              </div>
            </div>
          )}
